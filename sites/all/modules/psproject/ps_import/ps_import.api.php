 ...
 *
 * @see node_ps_import_types(),
 *      user_ps_import_types(),
 *      taxonomy_ps_import_types().
 *
 * @ingroup ps_import_hooks
 */
function hook_ps_import_types() {
}
 ...
 *
 * @param $types
 *   Array of content types as returned by hook_ps_import_types().
 *
 * @return
 ...
 * @ingroup ps_import_hooks
 */
function hook_ps_import_types_alter(&$types) {
}
 ...
 * have to do in hook_ps_import_values_alter().
 *
 ...
 *   the default "||").
 *
 *   Defaults to variable_get('ps_import:multiple_separator', '||').
 *
 ...
 *   default ">>").
 *
 *   Defaults to variable_get('ps_import:hierarchy_separator', '>>').
 *
 ...
 *
 *   If set, the ps_import_check_values() preprocessor will
 ...
 *   normally ps_import will not consider this as a valid
 ...
 *   be used in companion with the hook_ps_import_values_alter().
 *
 ...
 *
 *   See @ref ps_import_preprocess for examples.
 *
 *   Defaults to array().
 *
 ...
 * @ingroup ps_import_hooks
 */
function hook_ps_import_fields($type) {
}
 ...
 *
 * @param $fields
 *   Array of fields as returned by hook_ps_import_fields().
 *
 * @param $type
 *   String. The content type as returned as a key by
 *   hook_ps_import_types().
 ...
 * @ingroup ps_import_hooks
 */
function hook_ps_import_fields_alter(&$fields, $type) {
}
 ...
 * @endcode
 *
 * See hook_ps_import_values() for an alternative way to set
 ...
 * @ingroup ps_import_hooks
 */
function hook_ps_import_defaults($type, $defaults, $fields, $map) {
}
 ...
 * @ingroup ps_import_hooks
 */
function hook_ps_import_defaults_alter(&$form, $type, $defaults, $fields, $map) {
}
 ...
 * @ingroup ps_import_hooks
 */
function hook_ps_import_options($type, $options, $fields, $map) {
}
 ...
 * @ingroup ps_import_hooks
 */
function hook_ps_import_options_alter(&$form, $type, $options, $fields, $map) {
}
 ...
 * @ingroup ps_import_hooks
 */
function hook_ps_import_values($type, $defaults, $options, $fields, $preview) {
}
 ...
 *   does not only contain the values of hook_ps_import_values()
 ...
 * @ingroup ps_import_hooks
 */
function hook_ps_import_values_alter(&$values, $type, $defaults, $options, $fields, $preview) {
}
 ...
 * @ingroup ps_import_hooks
 */
function hook_ps_import_postprocess($type, $values, $options, $preview) {
}
 ...
 * @ingroup ps_import_hooks
 */
function hook_ps_import_task($task, $op) {
}
 ...
 * @ingroup ps_import_hooks
 */
function hook_ps_import_format_options($op) {
}
 ...
 *
 * @param $formats
 *   Return value of hook_ps_import_format_options().
 *
 * @param $op
 *   See hook_ps_import_format_options().
 *
 * @return
 *   Just like with any Drupal _alter() hook, you need to change the
 *   array passed to this function.
 ...
 * @ingroup ps_import_hooks
 */
function hook_ps_import_format_options_alter(&$formats, $op) {
}
